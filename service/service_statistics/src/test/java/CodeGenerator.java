...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("D:\\IdeaProjects\\gulischool\\service\\service_statistics" + "/src/main/java"); //输出目录，生成的代码最终输出的地方，请写你的项目的绝对路径
        ...
        pc.setModuleName("statistics_service"); //模块名 com.yzpnb.eduservice
        ...
        strategy.setInclude("statistics_daily");//你要为哪个表生成代码
